...
for elem = 1:numel
    ...
    % xl: (Ndim x Nel) Nodal positions for a particular element
    % ElemFlag: Corresponding global nodal index for a particular element
    xl = zeros(ndm, nel);
    ...
    switch iel
        ...
        case 2
            if ndm == 3
                ...
                [ElemK,ElemF] = L_Elem2_2d(xl,u,mateprop,nel,ndf,ndm,PSPS);
            end
