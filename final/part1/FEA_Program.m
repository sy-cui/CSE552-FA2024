...
%           1 -------------- 2       3-------1
%
% In addition, assume 'NodeCurr' is also defined (same shape as NodeTable) 
% 
...
% neq:  Number of equations excluding Dirichlet boundary
% nieq: Number of Dirichlet boundary equations
% nneq: Total number of equations 
nneq = neq + nieq;
...
% | K_dd K_df | | d_1 | = | f_1 |
% | K_fd K_ff | | d_2 |   | f_2 |
% All K, d_2, f_1 are known
SolveFE;

%%
% Node_U_V = NodeCurr-NodeTable;
% 
% maxuvw = zeros(ndm,1);
% maxxyz = zeros(ndm,1);
% for i = 1:ndm
...
%     PaperSize=papersize);
% % print -dpdf midterm_p1_contour.pdf -bestfit
% 
...
% set(gcf, PaperUnits='points', Position=[10 10 papersize], ...
%     PaperSize=papersize);
% % print -dpdf midterm_p1_deform.pdf -bestfit
