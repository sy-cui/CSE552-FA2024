function [ElemK, ElemF] = tang_elem_lin_2d(xr,mateprop,nel,ndf,lint,PSPS)
%
...
if PSPS == 's' %Plane Stress
    ...
    Dmat = ElemE/(1+Elemv)/(1-2*Elemv)*[1-Elemv Elemv    0;
                                        Elemv   1-Elemv  0;
                                        0       0        (1-2*Elemv)/2];     
end
